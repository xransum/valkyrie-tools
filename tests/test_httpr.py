"""Test suite for the valkyrie_tools.httpr module."""
...
class TestUserAgentList(unittest.TestCase):
    """Test suite for the valkyrie_tools.httpr.USER_AGENT_LIST constant."""
...
class TestDefaultUserAgent(unittest.TestCase):
    """Test suite for the valkyrie_tools.httpr.DEFAULT_USER_AGENT constant."""
...
class TestDefaultRequestHeaders(unittest.TestCase):
    """Test suite for the valkyrie_tools.httpr.DEFAULT_REQUEST_HEADERS constant."""
...
class TestFilterHeaders(unittest.TestCase):
    """Test suite for the valkyrie_tools.httpr.filter_headers function."""
...
class TestGetHttpVersion(unittest.TestCase):
    """Test suite for the valkyrie_tools.httpr.get_http_version function."""
...
class TestGetHTTPVersionText(unittest.TestCase):
    """Test suite for the valkyrie_tools.httpr.get_http_version_text function."""
...
class TestBuildFullURL(unittest.TestCase):
    """Test suite for the valkyrie_tools.httpr.build_full_url function."""
...
class TestExtractRedirectsFromHTMLMeta(unittest.TestCase):
    """Test suite for the valkyrie_tools.httpr.extract_redirects_from_html_meta function."""
    ...
    def test_invalid_meta_refresh_tag(self: unittest.TestCase) -> None:
        ...
        html = '<html><head><meta http-equiv="refresh" content="5;url=invalid-url"></head></html>'
        soup = BeautifulSoup(html, "html.parser")
        result = extract_redirects_from_html_meta(soup)
    ...
    def test_invalid_empty_meta_refresh_tag(self: unittest.TestCase) -> None:
        ...
        html = '<html><head><meta http-equiv="refresh" content="5;url="></head></html>'
        soup = BeautifulSoup(html, "html.parser")
        result = extract_redirects_from_html_meta(soup)
        self.assertEqual(result, "")

    def test_invalid_meta_refresh_empty_content(self: unittest.TestCase) -> None:
...
class TestGetNextUrl(unittest.TestCase):
    """Test suite for the valkyrie_tools.httpr.get_next_url function."""
...
class TestBuildRedirectChain(unittest.TestCase):
    ...
    def test_redirect_chain_with_follow_meta_true_no_meta_refresh_tag(
        ...
        """Test build_redirect_chain with follow_meta=True and no meta refresh tag."""
        url = "https://example.com"
        mock_response = Mock()
        mock_response.headers = {}
        mock_make_request.side_effect = [[url, mock_response]]
    ...
    def test_redirect_chain_with_follow_meta_true_valid_meta_refresh_tag(
        ...
        """Test build_redirect_chain with follow_meta=True and valid meta refresh tag."""
        url_chain = [
            "https://example.com",
